...
(The latter two types are found in the math/big package. Float uses arbitrar y but bounded-precision ﬂoating-point;
Rat uses unbounded-precision rational numbers.)
How do they compare in performance and memory usage? At what zoom levels do rendering artifacts become visible?
*/
...
import (
	...
	"github.com/jijiwhywhy/goplSolutions/chapter03/ex3.8/complexfloat"
	"github.com/jijiwhywhy/goplSolutions/chapter03/ex3.8/complexrat"
)
...
var verboseFlag = flag.Bool("verbose", true, "verbose:bool")
